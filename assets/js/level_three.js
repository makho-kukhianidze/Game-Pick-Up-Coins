...
var milliseconds = 250; // 850 milliseconds.
...
point.addEventListener('click', function () {
  ...
  coins.textContent = "Coins:" + " " + iPickUpCents + " / 1000 cents";
...
function startTimer() {
  ...
  if (iPickUpCents > 1000) { // if you pick up over 1000 cents - you won.
    youWon(); // Function youWon.
  }
  if (time < 1 && iPickUpCents < 999) { // if you pick up Less than 1000 cents - game over.
...
function youWon() {
  ...
  Swal.fire(
    'Well done! You won!',
    'Your coins:' + ' ' + iPickUpCents + ' / 1000 Cents',
    'success'
  );
}
