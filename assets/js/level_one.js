...
var milliseconds = 850; // 850 milliseconds.
...
point.addEventListener('click', function () {
  ...
  coins.textContent = "Coins:" + " " + iPickUpCents + " / 500 cents";
...
function startTimer() {
  ...
  if (iPickUpCents > 500) { // if you pick up over 500 cents - you won.
    youWon(); // Function youWon.
  }
  if (time < 1 && iPickUpCents < 499) { // if you pick up Less than 500 cents - game over.
...
function youWon() {
  ...
  Swal.fire(
    'Well done! You won!',
    'Your coins:' + ' ' + iPickUpCents + ' / 500 Cents',
    'success'
  );
}
...
// Copy disable - Start.
document.addEventListener("copy", function(copyIsNot){
copyIsNot.clipboardData.setData("text/plain", "Copying is not allowed");
  evt.preventDefault();
}, false);
// Copy disable - End.
